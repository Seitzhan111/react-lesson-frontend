...
const LoginPage: React.FC<IPropsLogin> = (props: IPropsLogin): JSX.Element => {
    ...
    return (
        <>
            ...
            <Typography variant="body1" sx={{fontFamily: 'Poppins'}}>У вас нет аккаунта?<span className={styles['incitingText']} onClick={() => navigate('/register')}>Регистрация</span></Typography>
        </>
    );
};
