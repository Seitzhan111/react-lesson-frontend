...
const RegisterPage: React.FC<IPropsRegister> = (props: IPropsRegister): JSX.Element => {
    ...
    return (
        <>
            ...
            <Typography variant="body1" sx={{fontFamily: 'Poppins'}}>У вас есть аккаунта?<span className={styles['incitingText']} onClick={() => navigate('/login')}>Авторизация</span></Typography>
        </>
    );
};
